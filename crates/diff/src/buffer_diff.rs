...
impl BufferDiff {
    ...
    fn compute_hunks(&mut self) -> Result<()> {
        ...
        if !diff.iter_all_changes().any(|c| c.tag() != similar::ChangeTag::Equal) {
                ...
                similar::ChangeTag::Delete => {
                    if current_hunk.is_none() {
                        ...
                        if let Some(hunk) = &mut current_hunk {
                            ...
                            hunk.line_types.push(crate::diff_hunk::DiffLineType::OldOnly);
                        }
                    }
                ...
                similar::ChangeTag::Insert => {
                    if current_hunk.is_none() {
                        ...
                        if let Some(hunk) = &mut current_hunk {
                            ...
                            hunk.line_types.push(crate::diff_hunk::DiffLineType::NewOnly);
                        }
                    }
